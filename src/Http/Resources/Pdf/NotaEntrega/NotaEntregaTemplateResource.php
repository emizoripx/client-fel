...
class NotaEntregaTemplateResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return array_merge([
            ...
            "detalles" => DetalleNotaEntregaTemplateResource::collection(json_decode(json_encode($fel_invoice->detalles)))->resolve()
