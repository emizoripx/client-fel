...
namespace EmizorIpx\ClientFel\Http\Resources\Pdf\FacturaVentaMineralesBcb;

use EmizorIpx\ClientFel\Http\Resources\Pdf\BaseTemplateResource;
use EmizorIpx\ClientFel\Utils\NumberUtils;

class FacturaVentaMineralesBcbTemplateResource extends BaseTemplateResource {
    ...
    public function toArray($request)
    {
        ...
        return array_merge($common, [
            ...
            "detalles" => DetalleFacturaVentaMineralesBcbTemplateResource::collection(json_decode(json_encode($fel_invoice->detalles)))->resolve()
        ]);
