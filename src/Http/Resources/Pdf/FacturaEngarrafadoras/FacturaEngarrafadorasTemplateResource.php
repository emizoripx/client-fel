...
class FacturaEngarrafadorasTemplateResource extends BaseTemplateResource {
    ...
    public function toArray($request)
    {
        ...
        return array_merge($common, [
            ...
            "totalPagar" => NumberUtils::number_format_custom( (float) ($fel_invoice->montoTotal) , 2),
            "montoTotalLiteral" => to_word((float)($fel_invoice->montoTotal), 2, 1),
            "detalles" => DetalleFacturaEngarrafadorasTemplateResource::collection(json_decode(json_encode($fel_invoice->detalles)))->resolve(),
