...
use EmizorIpx\ClientFel\Http\Resources\Pdf\FacturaPrevalorada\DetalleFacturaPrevaloradaTemplateResource;
use EmizorIpx\ClientFel\Utils\NumberUtils;

class FacturaPrevaloradaTemplateResource extends BaseTemplateResource {
    ...
    public function toArray($request)
    {
        ...
        return array_merge($common, [
            ...
            "detalles" => DetalleFacturaPrevaloradaTemplateResource::collection(json_decode(json_encode($fel_invoice->detalles)))->resolve(),
