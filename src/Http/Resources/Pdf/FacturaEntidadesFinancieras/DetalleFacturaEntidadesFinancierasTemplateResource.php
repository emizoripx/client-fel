...
class DetalleFacturaEntidadesFinancierasTemplateResource extends BaseDetalleTemplateResource {
    ...
    public function toArray($request)
    {
        ...
        $common['precioUnitario'] = intval($this->precioUnitario) < $this->precioUnitario ? NumberUtils::number_format_custom((float) $this->precioUnitario, 2) : NumberUtils::number_format_custom((float) $this->precioUnitario, 2);
