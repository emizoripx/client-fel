...
class FacturaSectorEducativoZonaFrancaTemplateResource extends BaseTemplateResource {
    ...
    public function toArray($request)
    {
        ...
        return array_merge($common, [
            ...
            "detalles" => DetalleFacturaSectorEducativoZonaFrancaTemplateResource::collection(json_decode(json_encode($fel_invoice->detalles)))->resolve(),
        ]);
