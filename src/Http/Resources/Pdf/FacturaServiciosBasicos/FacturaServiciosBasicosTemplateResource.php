...
class FacturaServiciosBasicosTemplateResource extends BaseTemplateResource {
    ...
    public function toArray($request)
    {
        ...
        return array_merge($common, [
            ...
            "totalPagar" => isset($fel_invoice->montoTotal) ? NumberUtils::number_format_custom( (float) ($fel_invoice->montoTotal - $fel_invoice->montoDescuentoLey1886 - $fel_invoice->montoDescuentoTarifaDignidad) , 2) : '0.00',
            "montoTotalLiteral" => to_word((float) ($fel_invoice->montoTotal - $fel_invoice->montoDescuentoLey1886 - $fel_invoice->montoDescuentoTarifaDignidad), 2, 1),
