...
class SectorEducativoZonaFrancaBuilder extends BaseFelInvoiceBuilder implements FelInvoiceBuilderInterface
{
        ...
        $input = array_merge(
            $this->input,[
                ...
                'data_specific_by_sector' => [
                    "nombreEstudiante" => $this->source_data['fel_data_parsed']['nombreEstudiante'],
    ...
    public function getDetailsAndTotals(): array
    {
        ...
        \Log::debug("TOTAL:>>>>>>>>>>>>>> " . json_encode([0, $total, round($this->source_data['fel_data_parsed']['montoGiftCard'], 2), round($this->source_data['fel_data_parsed']['descuentoAdicional'], 2)]));
        return [
