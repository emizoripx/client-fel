...
class EntidadFinancieraBuilder extends BaseFelInvoiceBuilder implements FelInvoiceBuilderInterface
{
        ...
        $input = array_merge(
            $this->input,[
                ...
                "data_specific_by_sector" => [
                    "montoTotalArrendamientoFinanciero" => $this->source_data['fel_data_parsed']["montoTotalArrendamientoFinanciero"],
                ],
            ],
    ...
    public function getDetailsAndTotals(): array
    {
        ...
        $total = $total + round($this->source_data['fel_data_parsed']['montoTotalArrendamientoFinanciero'],2) - round($this->source_data['fel_data_parsed']['descuentoAdicional'], 2);

        $totalsujetoiva = $total - round($this->source_data['fel_data_parsed']['montoTotalArrendamientoFinanciero'], 2);
