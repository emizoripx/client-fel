                ...
                if ($invoice_service->isSuccessful()) { 
                    ...
                    \DB::table("fel_invoice_requests")
                        ...
                        ->update([
                            ...
                            'package_id' => isset($result['package_id'])?$result['package_id']:null,
                            'uuid_package' => isset($result['uuid_package'])?$result['uuid_package']:null,
                            'index_package' => isset($result['index_package'])?$result['index_package']:null,
