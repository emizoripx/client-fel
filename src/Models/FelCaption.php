...
class FelCaption extends Model
{
    ...
    const PARAMETRIC_OFFLINE = '“Este documento es la Representación Gráfica de un Documento Fiscal Digital emitido fuera de línea, verifique su envío con su proveedor o en la página web <href="https://www.impuestos.gob.bo"> www.impuestos.gob.bo </a> .”';
