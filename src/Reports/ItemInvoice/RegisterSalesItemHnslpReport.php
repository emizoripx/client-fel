...
class RegisterSalesItemHnslpReport extends BaseReport implements ReportInterface {
    ...
    {
        $query_items = \DB::table('invoices')
            ->join('fel_invoice_requests', 'invoices.id', '=', 'fel_invoice_requests.id_origin')
