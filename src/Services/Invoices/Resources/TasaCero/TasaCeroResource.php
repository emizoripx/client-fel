...
namespace EmizorIpx\ClientFel\Services\Invoices\Resources\TasaCero;

use Illuminate\Http\Resources\Json\JsonResource;

class TasaCeroResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'detalles' => DetalleTasaCeroResource::collection(collect($this->detalles)),
