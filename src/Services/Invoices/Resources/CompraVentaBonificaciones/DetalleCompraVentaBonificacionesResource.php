...
namespace EmizorIpx\ClientFel\Services\Invoices\Resources\CompraVentaBonificaciones;

use Illuminate\Http\Resources\Json\JsonResource;

class DetalleCompraVentaBonificacionesResource extends JsonResource
{
    /**
