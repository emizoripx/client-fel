...
namespace EmizorIpx\ClientFel\Services\Invoices\Resources\ZonaFranca;

use Illuminate\Http\Resources\Json\JsonResource;

class ZonaFrancaResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'detalles' => DetalleZonaFrancaResource::collection(collect($this->detalles)),
