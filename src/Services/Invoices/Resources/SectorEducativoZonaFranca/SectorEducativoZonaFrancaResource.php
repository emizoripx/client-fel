...
namespace EmizorIpx\ClientFel\Services\Invoices\Resources\SectorEducativoZonaFranca;

use Illuminate\Http\Resources\Json\JsonResource;

class SectorEducativoZonaFrancaResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'detalles' => DetalleSectorEducativoZonaFrancaResource::collection(collect($this->detalles)),
