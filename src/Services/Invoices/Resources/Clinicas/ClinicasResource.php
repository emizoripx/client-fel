...
class ClinicasResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'detalles' => DetalleClinicasResource::collection(collect($this->detalles)),
            "emailCliente" => $this->emailCliente,
            "cafc" => $this->cafc,
            "codigoExcepcion" => $this->codigoExcepcion,
            "montoGiftCard" => round($this->montoGiftCard,2),
            "descuentoAdicional" => round($this->descuentoAdicional,2),
            "modalidadServicio" => isset($this->data_specific_by_sector['modalidadServicio']) ? $this->data_specific_by_sector['modalidadServicio'] : '', 
