...
class AlcanzadaIceResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            "montoIceEspecifico" => isset($this->data_specific_by_sector['montoIceEspecifico']) ? round($this->data_specific_by_sector['montoIceEspecifico'], 2) : 0,
            "montoIcePorcentual" => isset($this->data_specific_by_sector['montoIcePorcentual']) ? round($this->data_specific_by_sector['montoIcePorcentual'], 2) : 0,
