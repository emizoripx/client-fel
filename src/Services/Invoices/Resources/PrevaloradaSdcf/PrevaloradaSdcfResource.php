...
namespace EmizorIpx\ClientFel\Services\Invoices\Resources\PrevaloradaSdcf;

use Illuminate\Http\Resources\Json\JsonResource;

class PrevaloradaSdcfResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'detalles' => DetallePrevaloradaSdcfResource::collection(collect($this->detalles)),
