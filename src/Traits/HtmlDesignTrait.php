...
trait HtmlDesignTrait{
    ...
    public function makeRowsProductExportacionMinerales(){
        ...
        foreach($felInvoice->detalles as $line){
            ...
            <tr>
                ...
                <td style="padding-top: 10px; padding-bottom:10px;" class="b-solid center">'.number_format($line['cantidad'],5,',','.').' '.Unit::getUnitDescription($line['unidadMedida']).'</td>
                <td style="padding-top: 10px; padding-bottom:10px;" class="b-solid center">'.number_format($line['precioUnitario'],5,',','.').'  '. Currencies::getShortCode($felInvoice->codigoMoneda).'/'.Unit::getUnitDescription($line['unidadMedida']).'</td>
                <td style="padding-top: 10px; padding-bottom:10px;" class="b-solid right-align">'.number_format($line['subTotal'],5,',','.').' '. Currencies::getShortCode($felInvoice->codigoMoneda).'</td>
    ...
    public function appendFieldExportacionMinerales($data){
            ...
            $data['$fel.tipo_cambio'] = ['value' => number_format($this->fel_invoice->tipoCambio,5,',','.'), 'label' => 'Tipo Cambio Oficial'];
            $data['$fel.tipo_cambioANB'] = ['value' => number_format($this->fel_invoice->tipoCambioANB,5,',','.'), 'label' => 'Tipo Cambio ANB'];
            $data['$fel.numero_lote'] = ['value' => $this->fel_invoice->numeroLote, 'label' => 'Número Lote'];
            $data['$fel.kilos_netosHumedos'] = ['value' => number_format($this->fel_invoice->kilosNetosHumedos,2,',','.'), 'label' => 'Kilos Netos Húmedos'];
            $data['$fel.humedad_porcentaje'] = ['value' => (int) $this->fel_invoice->humedadPorcentaje, 'label' => 'Humedad Porcentaje'];
            $data['$fel.humedad_valor'] = ['value' => number_format($this->fel_invoice->humedadValor,2,',','.'), 'label' => 'Humedad Valor'];
            $data['$fel.merma_porcentaje'] = ['value' => (int) $this->fel_invoice->mermaPorcentaje, 'label' => 'Merma Porcentaje'];
            $data['$fel.merma_valor'] = ['value' => number_format($this->fel_invoice->mermaValor,2,',','.'), 'label' => 'Merma Valor'];
            $data['$fel.kilos_netosSecos'] = ['value' => number_format($this->fel_invoice->kilosNetosSecos,2,',','.'), 'label' => 'Kilos Netos Secos'];
            $data['$fel.gastos_realizacion'] = ['value' => number_format($this->fel_invoice->gastosRealizacion,2,',','.'), 'label' => 'Gastos Realización'];
            $data['$fel.valor_FOBFrontera'] = ['value' => number_format($this->fel_invoice->otrosDatos['valorFobFrontera'],2,',','.') , 'label' => 'Valor FOB Frontera'];
            $data['$fel.valor_FOBFronteraBs'] = ['value' => number_format($this->fel_invoice->otrosDatos['valorFobFronteraBs'],2,',','.'), 'label' => 'Valor FOB Frontera'];
            ...
            $data['$fel.fleteInternoUSD'] = ['value' => !empty($this->fel_invoice->otrosDatos['fleteInternoUSD']) ? 
                                            '<tr>
                                                ...
                                                <td class="b-solid right-align">'. number_format($this->fel_invoice->otrosDatos['fleteInternoUSD'] ,2,',','.').'</td>
                                            </tr>
                                            <tr>
            ...
            $data['$fel.valor_plata'] = ['value' => isset($this->fel_invoice->otrosDatos['valorPlata']) ? 
                                            '<tr>
                                                ...
                                                <td class="b-solid right-align">'. number_format( $this->fel_invoice->otrosDatos['valorPlata'] ,2,',','.').'</td>
                                            </tr>
                                            <tr>
            ...
            $data['$fel.partida_arancelaria'] = ['value' => isset($this->fel_invoice->otrosDatos['partidaArancelaria']) ? 
                                            '<tr>
                                                ...
                                                <td class="b-solid right-align">'. number_format($this->fel_invoice->otrosDatos['partidaArancelaria'],2,',','.') .'</td>
                                            </tr>
                                            <tr>
